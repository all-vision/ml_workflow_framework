      ...
      <CardContent>
        ...
        <Centered>
          ...
          <Typography variant="body2" component="div" gutterBottom>
            ...
            <Box fontWeight="fontWeightRegular">Sat Operator</Box>
          </Typography>
    ...
    <Card mb={6}>
      <CardContent>
        ...
        <Grid container direction="row" alignItems="center" mb={2}>
          ...
          <Grid item>
            Works at{" "}
            <Link href="https://material-app.bootlab.io/">Vandenberg AFB</Link>
          </Grid>
        </Grid>
        <Grid container direction="row" alignItems="center">
          ...
          <Grid item>
            Lives in <Link href="https://material-app.bootlab.io/">Santa Barbra</Link>
          </Grid>
        </Grid>
      </CardContent>
    </Card>
