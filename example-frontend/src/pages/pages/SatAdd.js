     ...
     <CardContent>
      <Typography variant="h6" gutterBottom>
        ...
        <Grid container spacing={6}>
          <Grid item md={6}>
            <TextField id="SatID" label="SatID" defaultValue={"25544"} variant="outlined" onChange={this.handleOnChangeLat} fullWidth my={2} />
          </Grid>
          <Grid item md={6}>
            <TextField id="SatName" label="SatName" defaultValue={"Space Station"} variant="outlined" onChange={this.handleOnChangeLong} fullWidth my={2} />
          </Grid>
        </Grid>
